...
import '../home_page/home_view/clinic_info.dart';
import '../home_page/home_view/doctors_list.dart';
import '../instants/colors.dart';
import '../instants/glass_box/glass_box.dart';

class DocClinicInfo extends StatefulWidget {
  const DocClinicInfo({Key? key}) : super(key: key);

  @override
  State<DocClinicInfo> createState() => _DocClinicInfoState();
}

class _DocClinicInfoState extends State<DocClinicInfo> {
  double rating=0;
  @override
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                GestureDetector(
                                  onTap: (){
                                    Get.snackbar('Hello Doctor', 'Your request is sent',
